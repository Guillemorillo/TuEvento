...
<body>
      ...
      <xsl:element name="img">
       ...
       <xsl:attribute name="width">
        ...
        <xsl:element name="img">
       <xsl:attribute name="src">
         <xsl:value-of select="imagen4/@ruta"/>
       </xsl:attribute>
       <xsl:attribute name="height">
         200
       </xsl:attribute>
       <xsl:attribute name="width">
         300
          ...
          <td><a href=""><xsl:element name="img">
       <xsl:attribute name="src">
         <xsl:value-of select="imagen5/@ruta"/>
       </xsl:attribute>
       <xsl:attribute name="height">
         200
       </xsl:attribute>
       <xsl:attribute name="width">
         300
          ...
          <td><a href=""><xsl:element name="img">
       <xsl:attribute name="src">
         <xsl:value-of select="imagen6/@ruta"/>
       </xsl:attribute>
       <xsl:attribute name="height">
         200
       </xsl:attribute>
       <xsl:attribute name="width">
        ...
        <tr>
          <td><xsl:value-of select="nombre4"/></td>
          <td><xsl:value-of select="nombre5"/></td>
          <td><xsl:value-of select="nombre6"/></td>
        </tr>
      </table>
